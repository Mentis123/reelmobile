...
## Operating principle (read this first, every time)

The agent's job is **not** to build a fishing game.
...
Every file in this pack exists to protect that paragraph.

If a decision does not make that paragraph more likely in a real player's hands, it is the wrong decision.
...
- Not an idle game
- Not a fishing economy simulator
- Not a multi-pond exploration game
- Not a Zelda clone (no copied assets, names, or music)
- Not a tutorial-driven experience
- Not a feature-stacked RPG with rod tiers, XP, or coin shops

## Reading order

1. `00_OVERVIEW.md` (this file)
2. `01_GAME_SPEC.md` — what the player does
3. `02_EXPERIMENT_PLAN.md` — Phase A / Phase B framing
4. `03_IMPLEMENTATION_PLAN.md` — milestones
5. `04_SPOTTING_AND_PERCEPTION.md` — the wedge mechanic
6. `05_PHYSICS_AND_FEEL.md` — how casting and line work
7. `06_MOBILE_WEB_CONSTRAINTS.md` — iOS Safari rules
8. `07_PERFORMANCE_BUDGET.md` — numeric targets
9. `08_ART_DIRECTION.md` — visual mood
10. `09_ASSET_GENERATION.md` — asset rules and prompts
11. `10_AUDIO_HAPTICS.md` — sound and feel
12. `11_FAILURE_AESTHETICS.md` — losing well
13. `12_VALIDATION.md` — how we know it works
...
22. `21_THE_REVEAL.md` — identity/size hidden in the dark, resolving as a fish is reeled into clear water (completes `19`'s pillar 3)
23. `22_THE_GEAR.md` — Chapter 8: two rods + three lures as pre-cast sidegrades that deepen the distance gamble (never an upgrade ladder)
